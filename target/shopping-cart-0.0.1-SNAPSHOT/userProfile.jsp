...
<%@ page
	import="com.virendra.service.impl.*,com.virendra.service.*,com.virendra.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color: #E6F9E6;">
	...
	if (user == null)
		user = new UserBean("Test User", 8878331132L, "test@gmail.com", "Pachpedi Naka ,Raipur , Chhattisgarh", 492001, "hello");
	%>
