...
import com.virendra.utility.MailMessage;
...
public class FansMessage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		response.setContentType("text/html");
		String htmlTextMessage = "" + "<html>" + "<body>" + "<h2 style='color:green;'>Message to TechNest</h2>" + ""
				...
				+ "</body>" + "</html>";
		String message = MailMessage.sendMessage("vmekhle@gmail.com", "Customer Message | " + name + " | " + email,
				htmlTextMessage);
