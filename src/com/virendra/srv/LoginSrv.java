...
import com.virendra.beans.UserBean;
import com.virendra.service.impl.UserServiceImpl;
...
public class LoginSrv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (userType.equals("virendraAdmin")) { // Login as Admin

			if (password.equals("virendraAdmin") && userName.equals("vmekhle@gmail.com")) {
				// valid
