...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "vmekhle@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to TechNest</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with TechNest.<br>"
					...
					+ "<span class='greenText'>TECHNEtST500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
